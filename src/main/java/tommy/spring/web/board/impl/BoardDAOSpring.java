...
public class BoardDAOSpring {
	...
	// 트랜잭션 private final String BOARD_INSERT = "insert into myboard(seq, title, writer, content) values(?,?,?,?)";  
	...
	public void insertBoard(BoardVO vo) {
		System.out.println("Spring JBDC로 insertBoard() 기능 처리");
    jdbcTemplate.update(BOARD_INSERT, vo.getTitle(), vo.getWriter(), vo.getContent());
	// 트랜잭션 jdbcTemplate.update(BOARD_INSERT,vo.getSeq(), vo.getTitle(), vo.getWriter(), vo.getContent());
	}
