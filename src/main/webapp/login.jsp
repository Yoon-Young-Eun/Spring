...
<body>
   ...
   <a href="login.do?lang=en"> <spring:message
         code="user.login.language.en" /></a>&nbsp;&nbsp;
   <a href="login.do?lang=ko"><spring:message
         code="user.login.language.ko" /></a>
   <hr>
   <!--  <form action="loginProc.jsp" method="post"> MVC1 방식-->
   <form action="login.do" method="post">
      <table border="1">
         <tr>
            <td><spring:message code="user.login.id" /></td>
            <!--  <td><input type="text" name="id" /></td> 18번째줄 EL태그 사용을 위해 주석처리  -->
            <td><input type="text" name="id" value="${userVO.id}" /></td>
         </tr>
         <tr>
            <td><spring:message code="user.login.password" /></td>
            <!--  <td><input type="password" name="password" /></td> 23번째줄 EL태그 사용을 위해 주석처리-->
